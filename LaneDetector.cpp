...
// Container containerSteeringData = getKeyValueDataStore().get(SteeringData::ID());
				...
				if(rightLaneLength<leftLaneLength && rightLaneLength > 2*leftLaneLength/3 && pt5.x != 0 && pt4.x !=640 && leftLaneLength - rightLaneLength > 15){
				...
				else if(rightLaneLength<leftLaneLength && rightLaneLength < 2*leftLaneLength/3 && pt5.x != 0 && pt4.x !=640 ){
					angle =-26;
					vc.setSteeringWheelAngle(angle);
					cout << "left " <<endl;

				}
				else if(rightLaneLength>leftLaneLength && 2*rightLaneLength/3 < leftLaneLength && pt5.x != 0 && pt4.x !=640 && rightLaneLength -leftLaneLength > 15 ){
				...
				else if(rightLaneLength>leftLaneLength && 2*rightLaneLength/3 < leftLaneLength && pt5.x != 0 && pt4.x !=640){
					angle =26;
					vc.setSteeringWheelAngle(angle);
					cout << "right" <<endl;
					...
					vc.setSpeed(0.5);
					cout << "blind on the left" <<endl;
					if (pt4.x != 640){
						if(rightLaneLength > 0 && rightLaneLength < 100){
					...
					vc.setSteeringWheelAngle(0);
					vc.setSpeed(0.5);
					cout << "blind on the right" <<endl;
					cout << leftLaneLength << endl;
					if (pt5.x != 0){
						if(leftLaneLength > 0 && leftLaneLength < 100){
							vc.setSteeringWheelAngle(26);
							cout << "Doing the if in if to turn right" << endl;
						}
						if (leftLaneLength> 250 && leftLaneLength <320){
							vc.setSteeringWheelAngle(-26);
							cout << "Doing the if in if to turn left" << endl;
						}
					}
